# This file was taken from the original authors. We have included it here so you can start training
# with some data without having to acquire data yourself.
